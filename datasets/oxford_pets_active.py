...
from dassl.utils import read_json, write_json, mkdir_if_missing, set_random_seed


@DATASET_REGISTRY.register()
class OxfordPets_Active(DatasetBase):

    dataset_dir = "oxford_pets"
    dataset_dir_active = "oxford_pets_active"
    ...
    def __init__(self, cfg):
        ...
        train, val, test = self.subsample_classes_for_active(train, val, test, num_class=num_class, subsample=subsample)
    ...
    @staticmethod
    def subsample_classes_for_active(*args, num_class, subsample="all"):
        """Divide classes into two groups. The first group
        represents base classes while the second group represents
        new classes.
